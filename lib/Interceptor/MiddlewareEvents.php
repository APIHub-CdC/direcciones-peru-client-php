...
namespace direcciones\pe\Client\Interceptor;
...
use \direcciones\pe\Client\Interceptor\KeyHandler;
use \direcciones\pe\Client\Interceptor\MyLogger;
use \direcciones\pe\Client\Model\Errors;
use \direcciones\pe\Client\Model\Error;

class MiddlewareEvents
{
    
    function __construct(\direcciones\pe\Client\Interceptor\KeyHandler $signer)
    {
        $this->signer = $signer;
...
function build_error($code, $message){
    $error = new \direcciones\pe\Client\Model\Error([
        "code" => $code,
        "message" => $message
    ]);
    $errors = new \direcciones\pe\Client\Model\Errores(["errors" => [$error]]);
